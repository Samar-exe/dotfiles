...
# Rofi CMD
rofi_cmd() {
    rofi -dmenu -replace -config ~/.config/rofi/applets/webSearch.rasi -i -no-show-icons -l 2 -width 30 -p "Take screenshot"
}
...
# CMD
timer_cmd() {
    rofi -dmenu -replace -config ~/.config/rofi/applets/webSearch.rasi -i -no-show-icons -l 5 -width 30 -p "Choose timer"
}
...
# CMD
type_screenshot_cmd() {
    rofi -dmenu -replace -config ~/.config/rofi/applets/webSearch.rasi -i -no-show-icons -l 3 -width 30 -p "Type of screenshot"
}
...
copy_save_editor_cmd() {
    rofi -dmenu -replace -config ~/.config/rofi/applets/webSearch.rasi -i -no-show-icons -l 4 -width 30 -p "How to save"
}
